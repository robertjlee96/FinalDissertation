...
The same process of hyperparameter optimzation as the previous models was used. 
...
Similarly to the $\gamma$ + Jet single photon BDT, then, it is clear that this data/MC BDT is not adequate alone to differentiate signal and background. The diphoton BDT, then, is a crucial step of the signal and background selection; by having access to both the single photon BDTs, the diphoton BDT can construct correlations that allow the final model to be considerably more discerning than input scores it uses. As will be shown in (REF?), this works to great effect. 
...
While the single photon quality scores given by the single photon BDTs are quite helpful, the diphoton kinematics are additionall a very strong source of discrimination power.
\begin{figure}[H]
	\begin{subfigure}{0.50\linewidth}
...
\begin{figure}[H]
	\centering
	\subfloat[][]{
		\includegraphics[width=.6\linewidth]{./Figures/Offline Selection Plots/0618_SingleH_JustHLTCuts/scEta_All_Sig.png}
	} \hfill \\
	\subfloat[][]{
		\includegraphics[width=.6\linewidth]{./Figures/Offline Selection Plots/0618_SingleH_JustHLTCuts/scEta_All_Bkg.png}
	}
	...
	\label{fig:SingleHOfflineAcceptedEta}
\end{figure}
\begin{figure}[H]
	\centering
	\subfloat[][]{
		\includegraphics[width=.6\linewidth]{./Figures/Offline Selection Plots/0618_SingleH_JustHLTCuts/ptOvrM_All_Sig.png}
	} \hfill \\
	\subfloat[][]{
		\includegraphics[width=.6\linewidth]{./Figures/Offline Selection Plots/0618_SingleH_JustHLTCuts/ptOvrM_All_Bkg.png}
	}
	...
	\label{fig:SingleHOfflineAcceptedPtm}
\end{figure}

\subsection{DiHiggs Signal Efficiency}

\section{Evaluation of Offline Selection Eficiency with MVA-HLT }
As discussed in chapter \ref{chapter:OfflineSelection}, no HLT exists 
\subsection{Method of Signal Efficiency Measurement}
\subsection{Single Higgs Signal Efficiency}
\begin{figure}[H]
	\centering
	\subfloat[][]{
		\includegraphics[width=.6\linewidth]{./Figures/Offline Selection Plots/0618_SingleH_OfflineSelectionCuts/hggMass_All_Sig.png}
	} \hfill \\
	\subfloat[][]{ 
		\includegraphics[width=.6\linewidth]{./Figures/Offline Selection Plots/0618_SingleH_OfflineSelectionCuts/hggMass_All_Bkg.png}
	}
	\caption[]{Diphoton invariant mass for the signal MC (left) and data (right). Events accepted by the MVA-HLT are shown in dark blue, while events accepted by the standard HLT are shown in dark green.}
	\label{fig:SingleHOfflineAcceptedMass}
\end{figure}
\begin{figure}[H]
	\centering
	\subfloat[][]{
		\includegraphics[width=.6\linewidth]{./Figures/Offline Selection Plots/0618_SingleH_OfflineSelectionCuts/scEta_All_Sig.png}
	} \hfill \\
	\subfloat[][]{
		\includegraphics[width=.6\linewidth]{./Figures/Offline Selection Plots/0618_SingleH_OfflineSelectionCuts/scEta_All_Bkg.png}
	}
	\caption[]{The $\eta_{sc}$ of both photons for the signal MC (left) and data (right). Events accepted by the MVA-HLT are shown in dark blue, while events accepted by the standard HLT are shown in dark green.}
	\label{fig:SingleHOfflineAcceptedEta}
\end{figure}
\begin{figure}[H]
	\centering
	\subfloat[][]{
		\includegraphics[width=.6\linewidth]{./Figures/Offline Selection Plots/0618_SingleH_OfflineSelectionCuts/ptOvrM_All_Sig.png}
	} \hfill \\
	\subfloat[][]{
		\includegraphics[width=.6\linewidth]{./Figures/Offline Selection Plots/0618_SingleH_OfflineSelectionCuts/ptOvrM_All_Bkg.png}
	}
	\caption[]{The $p_{T}/M_{\gamma \gamma}$ of both photons for the signal MC (left) and data (right). Events accepted by the MVA-HLT are shown in dark blue, while events accepted by the standard HLT are shown in dark green.}
	\label{fig:SingleHOfflineAcceptedPtm}
\end{figure}
