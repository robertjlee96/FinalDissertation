...
The new objective function can then be written as shown in equation \ref{eqn:BasicObjective} \cite{XGBoostPaper}.
...
\subsection{SciKit-Learn Implementation of XGBoost} \label{sec:SciKitLearn}
