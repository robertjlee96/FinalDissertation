...
\begin{figure}[H]
	...
	\end{subfigure}
	\caption{$H \rightarrow \gamma \gamma$ acceptance of the MVA-HLT (dark blue) vs. the current diphoton sHLT (green) for $M_{\gamma \gamma}$. Events that pass the MVA-HLT but fail the sHLT can be seen in light blue.}
...
\begin{figure}[H]
	...
	\end{subfigure}
	\caption{$H \rightarrow \gamma \gamma$ acceptance of the MVA-HLT (dark blue) vs. the current diphoton sHLT (green) for $\eta_{SC}$. Both the lead and sublead photons are plotted together. Events that pass the MVA-HLT but fail the sHLT can be seen in light blue.}
