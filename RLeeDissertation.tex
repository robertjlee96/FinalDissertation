...
The features of the $\eta_{SC}$ distributions for the data and MC differ considerably more than those for the $\gamma$ + Jet prompt and fake distributions.
...
\subsection{Determination of Loose Single Photon MVA Cuts for $H \rightarrow \gamma \gamma$}
...
\subsection{Single Higgs MVA-HLT Acceptance}
\begin{figure}[H]
	\begin{subfigure}{0.50\linewidth}
...
\begin{figure}[H]
	\begin{subfigure}{0.50\linewidth}
		...
		\caption{Signal MC $p_{T}/M_{\gamma \gamma}$}
	...
	\begin{subfigure}{0.50\linewidth}
		...
		\caption{Data $p_{T}/M_{\gamma \gamma}$}
		\label{SingleHBkg:HLTAcceptance:Ptm}
	\end{subfigure}
	\caption{Acceptance of the MVA-HLT (blue) vs. the current standard diphoton HLT (green) for $p_{T}/M_{\gamma \gamma}$. Both the lead and sublead photons are plotted together.}
...
\subsection{DiHiggs MVA-HLT Acceptance}
