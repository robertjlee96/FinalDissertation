...
\begin{figure}[H]
	...
	\caption{The "Sombrero Potential" which spontaneously breaks the symmetry of an example U(1) group. The non-zero vacuum expecation value can be seen with a value of.}
