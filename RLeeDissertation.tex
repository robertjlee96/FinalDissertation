...
\subsection{Determination of Loose Single Photon MVA Cuts for $HH \rightarrow b \bar{b} \gamma \gamma$}
...
Finally, the electron veto values look very similar to those of the single Higgs data and MC. Shown in figure \ref{fig:DiHiggs:DiphoVars6}, it is still the case that the signal MC has both photons passing the veto in >95\% of cases. Again, this will prove a very useful discrimination variable.
...
\begin{figure}[H]
	...
	\end{subfigure}
	\caption{Acceptance of the MVA-HLT (dark blue) vs. the current standard diphoton HLT (green) for $p_{T}/M_{\gamma \gamma}$. Both the lead and sublead photons are plotted together. Events that pass the MVA-HLT but fail the standard HLT can be seen in light blue.}
...
Where the MVA-HLT can sine best, however, is for more rare processes like the $HH \rightarrow b \bar{b} \gamma \gamma$.
\begin{figure}[H]
	\begin{subfigure}{0.50\linewidth}
