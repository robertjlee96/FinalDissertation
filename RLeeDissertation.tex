...
Quantum electrodynamics was the first successful field theory proposed, and was originally created to describe the phenomena of the electromagnetic forces \cite{SMOverview}. This original theory was built on U(1) gauge symmetry, and therefore has one gauge boson (the photon). 

\section{Quantum Chromodynamics (QCD)}\label{sec:QCD}
Use Gaillard, Grannis, and Sciulli AND PDG Physics summary page 153

Mention quark confinement, hadronic jets!
...
For this analysis, the major decay channel of interest will be the diphoton, or $\gamma \gamma$ decay. This is, again, represented by the Feynman diagrams in figure \ref{fig:SingleHDecayModes}i\&j. Looking at table \ref{tab:singleHDecayBR} and figure \ref{fig:BRSingleHDecayModes}, it is clear that this decay channel has a very low branching fraction compared to some of the higher-rate channels at only only 0.2 \%. 
